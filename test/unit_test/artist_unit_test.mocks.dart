...
// in sangeet/test/unit_test/artist_unit_test.dart.
...
class MockArtistUseCase extends _i1.Mock implements _i4.ArtistUseCase {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.ArtistEntity>>> getAllArtists(
          int? page) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllArtists,
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.ArtistEntity>> getArtist(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getArtist,
          [id],
